...
/// مستندات المورد: عقود توريد، فواتير، أو أي مستند تاني - عدد غير محدود،
/// كل مستند بنوع وعنوان وصورة، قابل للإضافة أو الحذف في أي وقت.
class SupplierDocumentsScreen extends StatefulWidget {
  final Supplier supplier;

  const SupplierDocumentsScreen({super.key, required this.supplier});

  @override
  State<SupplierDocumentsScreen> createState() => _SupplierDocumentsScreenState();
}

class _SupplierDocumentsScreenState extends State<SupplierDocumentsScreen> {
  ...
  Future<void> _load() async {
    ...
    final documents = await _repository.getDocumentsForSupplier(widget.supplier.id!);
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('مستندات ${widget.supplier.companyName}')),
